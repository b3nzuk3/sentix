...
exports.themeExtractionPrompt = void 0;
function renderTemplate(template, context) {
    // Helper to replace loops with indices
    const processLoop = (content, items, indexName, itemName) => {
        return items.map((item, idx) => {
            ...
            // Replace {{ item.xxx }}
            const replaceVar = (varName, value) => {
...
//# sourceMappingURL=themeExtraction.js.map